...
class SnackbarManager {
    ...
    public void show(int duration, SnackbarManager.Callback callback) {
        synchronized (mLock) {
            if (isCurrentSnackbarLocked(callback)) {
                ...
                mNextSnackbar = new SnackbarManager.SnackbarRecord(duration, callback);
            }
    ...
    private void showNextSnackbarLocked() {
        if (mNextSnackbar != null) {
            ...
            final SnackbarManager.Callback callback = mCurrentSnackbar.callback.get();
            if (callback != null) {
                callback.show();
            } else {
    ...
    private boolean cancelSnackbarLocked(SnackbarManager.SnackbarRecord record, int event) {
        final SnackbarManager.Callback callback = record.callback.get();
        if (callback != null) {
