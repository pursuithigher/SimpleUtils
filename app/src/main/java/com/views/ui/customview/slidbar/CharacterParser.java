...
/**
 * this is used by Slidbar
 * @author ubuntu
 *
 */
public class CharacterParser
{
	private static final Class<CharacterParser> TAG = CharacterParser.class;
	...
	{
//		try {
//			String chsmsg=new String(chs.getBytes("utf-8"));
//			if(chsmsg.equals(chs))
//			{
//				chs=changeCharset(chs,"gb2312");
//			}
...
//		}
		...
		try
		{
			byte[] bytes = chs.getBytes("gb2312");//utf-8
		...
		{
			//MyLog.i(TAG, "ERROR:ChineseSpelling.class-getChsAscii(String chs)" + e);
		}
		return asc;
	}
	...
	{
		try {
			if(new String(str.getBytes("utf-8")).equals(str))
				if (str.matches("[\\u4E00-\\u9FA5]+")) {
					HanyuPinyinOutputFormat t3 = new HanyuPinyinOutputFormat();
					t3.setVCharType(HanyuPinyinVCharType.WITH_V);
				    try 
				    {
						String[] result = PinyinHelper.toHanyuPinyinStringArray(str.toCharArray()[0], t3);
						return result[0];
