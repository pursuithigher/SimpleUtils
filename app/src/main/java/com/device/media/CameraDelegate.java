...
public class CameraDelegate {
    ...
    public void initialCamear2(ContextThemeWrapper context,SurfaceHolder mSurfaceHolder) throws Exception {
        //获取摄像头管理
        ...
        imageReader = ImageReader.newInstance(480,720, ImageFormat.JPEG,1);
...
//                iv_show.setVisibility(View.VISIBLE);
     ...
     * 拍照
     */
    private void takePicture(AppCompatActivity context) {
        if (camera2 == null)
            return;
