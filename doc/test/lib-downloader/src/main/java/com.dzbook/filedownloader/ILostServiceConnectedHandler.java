...
public interface ILostServiceConnectedHandler {
     ...
     */
    boolean isInWaitingList(com.dzbook.filedownloader.BaseDownloadTask.IRunningTask task);
     ...
     */
    void taskWorkFine(com.dzbook.filedownloader.BaseDownloadTask.IRunningTask task);
     ...
     */
    boolean dispatchTaskStart(com.dzbook.filedownloader.BaseDownloadTask.IRunningTask task);
}
