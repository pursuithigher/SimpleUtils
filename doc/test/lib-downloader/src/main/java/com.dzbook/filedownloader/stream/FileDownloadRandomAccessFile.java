...
package com.dzbook.filedownloader.stream;
...
public class FileDownloadRandomAccessFile implements com.dzbook.filedownloader.stream.FileDownloadOutputStream {
    ...
    public static class Creator implements FileDownloadHelper.OutputStreamCreator {
        ...
        @Override
        public com.dzbook.filedownloader.stream.FileDownloadOutputStream create(File file) throws IOException {
