 ...
 */
public class DownloadEventSampleListener extends com.dzbook.filedownloader.event.IDownloadListener {
...
//    }
    ...
    @Override
    public boolean callback(com.dzbook.filedownloader.event.IDownloadEvent event) {
