...
import com.dzbook.filedownloader.DownloadTask;
import com.dzbook.filedownloader.IThreadPoolMonitor;
...
import com.dzbook.filedownloader.model.ConnectionModel;
 ...
 * else:
 * create single first connection and use {@link com.dzbook.filedownloader.download.FetchDataTask} to fetch data from the
 * connection.
 * <p/>
...
public class DownloadLaunchRunnable implements Runnable, ProcessCallback {
    ...
    private final ArrayList<com.dzbook.filedownloader.download.DownloadRunnable> downloadRunnableList = new ArrayList<>(
            DEFAULT_CONNECTION_COUNT);
    private com.dzbook.filedownloader.download.DownloadRunnable singleDownloadRunnable;
    ...
    private List<Future<Object>> subTaskFutures;
    ...
    private DownloadLaunchRunnable(FileDownloadModel model, FileDownloadHeader header,
        ...
        this.database = com.dzbook.filedownloader.download.CustomComponentHolder.getImpl().getDatabaseInstance();
        this.supportSeek = com.dzbook.filedownloader.download.CustomComponentHolder.getImpl().isSupportSeek();
    ...
    public void pause() {
        ...
        if (singleDownloadRunnable != null) {
            singleDownloadRunnable.pause();
        }
        @SuppressWarnings("unchecked") ArrayList<com.dzbook.filedownloader.download.DownloadRunnable> pauseList =
                (ArrayList<com.dzbook.filedownloader.download.DownloadRunnable>) downloadRunnableList.clone();
        for (com.dzbook.filedownloader.download.DownloadRunnable runnable : pauseList) {
            if (runnable != null) {
                runnable.pause();
        ...
        try {
            ...
            do {
                ...
                try {
                    ...
                    startRealConnect(connectionOnDBList, totalLength, connectionCount);
    ...
    private void handleAliveFinally() {
    ...
    private void startRealConnect(List<ConnectionModel> connectionOnDBList, long totalLength, int connectionCount) throws IOException, IllegalAccessException, InterruptedException {
    ...
    private void trialConnect() throws IOException, RetryDirectly, IllegalAccessException,
        ...
        try {
            final com.dzbook.filedownloader.download.ConnectionProfile trialConnectionProfile;
            if (isNeedForceDiscardRange) {
                trialConnectionProfile = com.dzbook.filedownloader.download.ConnectionProfile.ConnectionProfileBuild
                        .buildTrialConnectionProfileNoRange();
            } else {
                trialConnectionProfile = com.dzbook.filedownloader.download.ConnectionProfile.ConnectionProfileBuild
                        .buildTrialConnectionProfile();
            }
            final com.dzbook.filedownloader.download.ConnectTask trialConnectTask = new com.dzbook.filedownloader.download.ConnectTask.Builder()
    ...
    private void handleTrialConnectResult(Map<String, List<String>> requestHeader,
        ...
        boolean isPreconditionFailed = checkCode(connectTask, code, onlyFromBeginning, oldEtag, newEtag);
    ...
    private boolean checkCode(ConnectTask connectTask, int code, boolean onlyFromBeginning, String oldEtag, String newEtag) {
    ...
    private void realDownloadWithSingleConnection(final long totalLength)
        ...
        // connect
        final com.dzbook.filedownloader.download.ConnectionProfile profile;
        if (!acceptPartial) {
            model.setSoFar(0);
            profile = com.dzbook.filedownloader.download.ConnectionProfile.ConnectionProfileBuild
        ...
        singleDownloadRunnable = new com.dzbook.filedownloader.download.DownloadRunnable.Builder()
                .setId(model.getId())
    ...
    private void realDownloadWithMultiConnectionFromBeginning(final long totalLength,
        ...
        for (int i = 0; i < connectionCount; i++) {
            ...
            if (i == connectionCount - 1) {
                ...
                endOffset = com.dzbook.filedownloader.download.ConnectionProfile.RANGE_INFINITE;
            } else {
    ...
    private void fetchWithMultipleConnection(final List<ConnectionModel> connectionModelList,
        ...
        for (ConnectionModel connectionModel : connectionModelList) {
            ...
            contentLength = getContentLength(totalLength, connectionModel);

            totalOffset += connectionModel.getCurrentOffset() - connectionModel.getStartOffset();

            if (needContinue(connectionModel, contentLength)) {
                continue;
            }

            final com.dzbook.filedownloader.download.DownloadRunnable.Builder builder = new com.dzbook.filedownloader.download.DownloadRunnable.Builder();

            final com.dzbook.filedownloader.download.ConnectionProfile connectionProfile = ConnectionProfile.ConnectionProfileBuild
            ...
            final com.dzbook.filedownloader.download.DownloadRunnable runnable = builder
                    .setId(id)
        ...
        for (com.dzbook.filedownloader.download.DownloadRunnable runnable : downloadRunnableList) {
            if (paused) {
                runnable.pause();
                continue;
            }
        ...
        setSubTaskFutures(DOWNLOAD_EXECUTOR.invokeAll(subTasks));
        if (FileDownloadLog.NEED_LOG) {
            for (Future<Object> future : getSubTaskFutures()) {
    ...
    private boolean needContinue(ConnectionModel connectionModel, long contentLength) {
        if (contentLength == 0) {
    ...
    private long getContentLength(long totalLength, ConnectionModel connectionModel) {
        long contentLength;
    ...
    public void setSubTaskFutures(List<Future<Object>> subTaskFutures) {
        this.subTaskFutures = subTaskFutures;
    }
    ...
    @Override
    public void onCompleted(com.dzbook.filedownloader.download.DownloadRunnable doneRunnable, long startOffset, long endOffset) {
        if (paused) {
            if (FileDownloadLog.NEED_LOG) {
    ...
    public void onError(Exception exception) {
        ...
        // discard all
        @SuppressWarnings("unchecked") ArrayList<com.dzbook.filedownloader.download.DownloadRunnable> discardList =
                (ArrayList<com.dzbook.filedownloader.download.DownloadRunnable>) downloadRunnableList.clone();
     ...
     * 自定义异常
     */
    static class RetryDirectly extends Throwable {
    }

    /**
     * 自定义异常
     */
    static class DiscardSafely extends Throwable {
    }
    ...
    public static class Builder {
         ...
         * @return 构造器
         */
        public Builder setModel(FileDownloadModel amodel) {
            this.model = amodel;
            return this;
        }
         ...
         * 设置header
         *
         * @param aHeader 下载header
         * @return buidler构造
         */
        public Builder setHeader(FileDownloadHeader aHeader) {
            this.header = aHeader;
            return this;
        }
         ...
         * 设置monitor
         *
         * @param aThreadPoolMonitor monitor
         * @return build构造
         */
        public Builder setThreadPoolMonitor(IThreadPoolMonitor aThreadPoolMonitor) {
            this.threadPoolMonitor = aThreadPoolMonitor;
            return this;
        }
         ...
         *
         * @param aMinIntervalMillis 最小值
         * @return build构造
         */
        public Builder setMinIntervalMillis(Integer aMinIntervalMillis) {
            this.minIntervalMillis = aMinIntervalMillis;
            return this;
        }
         ...
         * 回调
         *
         * @param aCallbackProgressMaxCount 最大数
         * @return build构造
         */
        public Builder setCallbackProgressMaxCount(Integer aCallbackProgressMaxCount) {
            this.callbackProgressMaxCount = aCallbackProgressMaxCount;
            return this;
        }
         ...
         * 设置wifi
         *
         * @param wifiRequired wifiRequired
         * @return build构造
         */
         ...
         * 设置最大时间
         *
         * @param aMaxRetryTimes 最大时间
         * @return build构造
         */
        public Builder setMaxRetryTimes(Integer aMaxRetryTimes) {
            this.maxRetryTimes = aMaxRetryTimes;
            return this;
        }
        ...
        public DownloadLaunchRunnable build() {
            boolean result = model == null || threadPoolMonitor == null || minIntervalMillis == null || callbackProgressMaxCount == null;
            if (result || isForceReDownload == null || isWifiRequired == null
                    || maxRetryTimes == null) {
                throw new IllegalArgumentException();
            }
