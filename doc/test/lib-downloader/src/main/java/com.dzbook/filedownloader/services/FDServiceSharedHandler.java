...
import com.dzbook.filedownloader.FileDownloadServiceProxy;
import com.dzbook.filedownloader.IFileDownloadIPCCallback;
import com.dzbook.filedownloader.IFileDownloadIPCService;
...
public class FDServiceSharedHandler extends IFileDownloadIPCService.Stub
    ...
    private final com.dzbook.filedownloader.services.FileDownloadManager downloadManager;
    private final WeakReference<com.dzbook.filedownloader.services.FileDownloadService> wService;

    FDServiceSharedHandler(WeakReference<com.dzbook.filedownloader.services.FileDownloadService> wService,
                           com.dzbook.filedownloader.services.FileDownloadManager manager) {
    ...
    public void startForeground(int id, Notification notification) {
        if (this.wService != null && this.wService.get() != null) {
            FileDownloadService fileDownloadService = this.wService.get();
            if (fileDownloadService != null) {
                fileDownloadService.startForeground(id, notification);
            }
        }
    }
    ...
    public void stopForeground(boolean removeNotification) {
        if (this.wService != null && this.wService.get() != null) {
            FileDownloadService fileDownloadService = this.wService.get();
            if (fileDownloadService != null) {
                fileDownloadService.stopForeground(removeNotification);
            }
        }
    }
