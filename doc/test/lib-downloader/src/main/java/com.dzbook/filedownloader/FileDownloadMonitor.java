 ...
 *
 * @see com.dzbook.filedownloader.BaseDownloadTask.LifeCycleCallback#onBegin()
 * @see com.dzbook.filedownloader.BaseDownloadTask.LifeCycleCallback#onOver() ()
 * @see com.dzbook.filedownloader.BaseDownloadTask#start()
 * @see com.dzbook.filedownloader.FileDownloader#start(FileDownloadListener, boolean)
 */
public class FileDownloadMonitor {
    private static IMonitor monitor;

    public static void setGlobalMonitor(final IMonitor aMonitor) {
        FileDownloadMonitor.monitor = aMonitor;
    }

    /**
     * releaseGlobalMonitor
     */
    ...
    public interface IMonitor {
         ...
         */
        void onRequestStart(com.dzbook.filedownloader.BaseDownloadTask task);
         ...
         */
        void onTaskBegin(com.dzbook.filedownloader.BaseDownloadTask task);
         ...
         */
        void onTaskStarted(com.dzbook.filedownloader.BaseDownloadTask task);
