 ...
 *
 * @see com.dzbook.filedownloader.services.FileDownloadService The service for FileDownloader.
...
public class FileDownloader {
    ...
    private static volatile IQueuesHandler mQueuesHandler;
    private static final Object INIT_LOST_CONNECTED_HANDLER_LOCK = new Object();
    private static volatile ILostServiceConnectedHandler mLostConnectedHandler;
     ...
     * <p>
     * We wrap the message package which size is {@link FileDownloadMessageStation#subPackageSize}
    ...
    public static void setGlobalHandleSubPackageSize(final int packageSize) {
        ...
        FileDownloadMessageStation.subPackageSize = packageSize;
    }
    ...
    public BaseDownloadTask create(final String url) {
        return new com.dzbook.filedownloader.DownloadTask(url);
    }
    ...
    public boolean clear(final int id, final String targetFilePath) {
        ...
        if (FileDownloadServiceProxy.getImpl().clearTaskData(id)) {
            ...
            if (intermediateFile.exists()) {
                ...
                boolean delete = intermediateFile.delete();
    ...
    IQueuesHandler getQueuesHandler() {
        if (mQueuesHandler == null) {
            synchronized (INIT_QUEUES_HANDLER_LOCK) {
                if (mQueuesHandler == null) {
                    mQueuesHandler = new com.dzbook.filedownloader.QueuesHandler();
                }
            }
        }
