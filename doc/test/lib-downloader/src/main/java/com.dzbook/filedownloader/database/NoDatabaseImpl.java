...
package com.dzbook.filedownloader.database;
...
public class NoDatabaseImpl implements FileDownloadDatabase {
     ...
     * 接口回调
     */
    static class Maintainer implements FileDownloadDatabase.Maintainer {
     ...
     * 内部迭代器类
     */
    static class MaintainerIterator implements Iterator<FileDownloadModel> {
        ...
        public FileDownloadModel next() {
            //hasNext 为false 之前return null 这个地方不会执行到，为了清除findbugs 暂时返回FileDownloadModel
