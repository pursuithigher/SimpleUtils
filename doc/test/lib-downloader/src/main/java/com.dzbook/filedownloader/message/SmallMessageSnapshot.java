 ...
 *
 * @see com.dzbook.filedownloader.message.LargeMessageSnapshot
 * @see BlockCompleteMessage
 */
public abstract class SmallMessageSnapshot extends com.dzbook.filedownloader.message.MessageSnapshot {
