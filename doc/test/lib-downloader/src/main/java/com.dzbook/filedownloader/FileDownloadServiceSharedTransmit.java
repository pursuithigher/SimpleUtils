...
import com.dzbook.filedownloader.services.FDServiceSharedHandler;
import com.dzbook.filedownloader.services.FDServiceSharedHandler.FileDownloadServiceSharedConnection;
import com.dzbook.filedownloader.services.FileDownloadService.SharedMainProcessService;
 ...
 *
 * @see com.dzbook.filedownloader.FileDownloadServiceUIGuard
 */
class FileDownloadServiceSharedTransmit implements
    ...
    @Override
    public void onConnected(final FDServiceSharedHandler aHandler) {
        ...
        com.dzbook.filedownloader.FileDownloadEventPool.getImpl().
