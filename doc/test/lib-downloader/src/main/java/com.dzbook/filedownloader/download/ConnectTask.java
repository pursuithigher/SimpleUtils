...
import com.dzbook.filedownloader.connection.RedirectHandler;
...
public class ConnectTask {
     ...
     * @param aprofile 连接信息
     * @param aetag    tag
     * @throws Reconnect 连接异常
     */
    public void retryOnConnectedWithNewParam(ConnectionProfile aprofile, String aetag)
            throws Reconnect {
        if (profile == null) {
     ...
     * 异常
     */
    static class Reconnect extends Throwable {
    }
...
// -----------------
    ...
    static class Builder {
        ...
        public Builder setEtag(String aetag) {
            this.etag = aetag;
            return this;
        }
