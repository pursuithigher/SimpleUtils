...
public final class SignInApi extends BaseApiAgent {
    ...
    public void onConnect(int rst, HuaweiApiClient client) {
        ...
        PendingResult<SignInResult> signInResult = HuaweiId.HuaweiIdApi.signIn(null, client);
            ...
            public void onResult(SignInResult result) {
                ...
                if ((rstCode == CommonCode.ErrorCode.SESSION_INVALID || rstCode == CommonCode.ErrorCode.CLIENT_API_INVALID) && retryTimes > 0) {
                    ...
                    if (result.isSuccess()) {
                        ...
                        if (forceLogin && (rstCode == HuaweiIdStatusCodes.SIGN_IN_UNLOGIN || rstCode == HuaweiIdStatusCodes.SIGN_IN_AUTH || rstCode == HuaweiIdStatusCodes.SIGN_IN_CHECK_PASSWORD)) {
     ...
     * 帐号登录请求
     *
     * @param forceLogin1 是否强制登录。当只需要知道当前登录状态时填false，其他填true
     * @param handler1    登录结果回调
     */
    public void signIn(boolean forceLogin1, final SignInHandler handler1) {
        HMSAgentLog.d("handler=" + handler1);
