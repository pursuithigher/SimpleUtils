...
public class CircularProgressView extends View {
    ...
    private void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        int defaultColor = CompatUtils.getColor(getContext(), R.color.cpv_default_color);
        // If color explicitly provided
        if (a.hasValue(R.styleable.CircularProgressView_cpv_color)) {

            color = a.getColor(R.styleable.CircularProgressView_cpv_color, defaultColor);
            ...
            color = t.getColor(0, defaultColor);
        } else {
            //Use default color
            color = defaultColor;
        }
    ...
    public void setIndeterminate(boolean indeterminate) {
        ...
        boolean reset = this.isIndeterminate == indeterminate;
        ...
        if (old != indeterminate) {
            for (CircularProgressViewListener listener : listeners) {
                listener.onModeChanged(indeterminate);
            }
        }
    }
    ...
    public void setProgress(final float progress) {
        ...
        if (!isIndeterminate) {
            ...
            progressAnimator = ValueAnimator.ofFloat(actualProgress, progress);
            ...
            progressAnimator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    for (CircularProgressViewListener listener : listeners) {
                        listener.onProgressUpdateEnd(progress);
                    }
                }
            });
