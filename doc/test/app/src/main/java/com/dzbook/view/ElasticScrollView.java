...
public class ElasticScrollView extends ScrollView {
    ...
    private boolean isShouldMove(int deltaY) {
        return (canPullDown && deltaY > 0)    //可以下拉， 并且手指向下移动
    ...
    public interface ScrollViewListener {
         ...
         * @param oldy       oldy
         */
        void onScrollChanged(ElasticScrollView scrollView, int x, int y, int oldx, int oldy);
