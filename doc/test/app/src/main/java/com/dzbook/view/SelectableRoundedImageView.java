...
public class SelectableRoundedImageView extends ImageView {
    ...
    private static final String TAG = "SelectableRoundedImg";
    private static final int DEFAULT_BORDER_COLOR = Color.BLACK;

    private static final ScaleType[] S_SCALE_TYPE_ARRAY = {ScaleType.MATRIX, ScaleType.FIT_XY, ScaleType.FIT_START, ScaleType.FIT_CENTER, ScaleType.FIT_END, ScaleType.CENTER, ScaleType.CENTER_CROP, ScaleType.CENTER_INSIDE};
    ...
    private Drawable resolveResource() {
        if (mResource != 0) {
            try {
                ...
                if (null != context) {
                    Drawable d = CompatUtils.getDrawable(context, mResource);
    ...
    static class SelectableRoundedCornerDrawable extends Drawable {
        ...
        private static final String TAG = "Selectable...Drawable";
        private static final int DEFAULT_BORDER_COLOR = Color.BLACK;
