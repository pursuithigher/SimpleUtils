...
import com.dzbook.view.vip.PrivilegeVipView;
 ...
 * @author gavin
 */
public class VipPrivilegeAdapter extends DelegateAdapter.Adapter<VipViewHolder> {
    ...
    public VipViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new VipViewHolder(new PrivilegeVipView(mContext));
    }
